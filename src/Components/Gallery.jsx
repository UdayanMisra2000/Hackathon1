...
export default function Gallery() {
  ...
  <div className="gallery__item gallery__item--v-2">
  ...
  <div className="gallery__item gallery__item--h-2">
  ...
  <div className="gallery__item gallery__item--h-2 gallery__item--v-2">
    <div className="embed">
  ...
  <div className="gallery__item gallery__item--h-2 gallery__item--v-3">
